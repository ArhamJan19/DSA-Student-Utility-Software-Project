...
public class NotesController {
    ...
    public void initialize() {
        UploadBtn.setOnAction(event -> {
            if (fileDropped && droppedFile != null) {
                ...
                showAlert(Alert.AlertType.INFORMATION,"No File!","No file dropped to upload.");
    ...
    public void undoRecentNote() {
        if (!recentNotesStack.isEmpty()) {
            ...
            notesList.setAll(notesQueue);
            showAlert(Alert.AlertType.INFORMATION,"Success!","Recent Note Removed Successfully!");
        }
    }
    ...
    public void extractNote() {
        ...
        if (selectedNote != null) {
            ...
            showAlert(Alert.AlertType.INFORMATION,"Success!","Note Extracted Successfully!");
        }
    }
    ...
    public void deleteNote() {
        ...
        if (selectedNote != null) {
            ...
            try (Connection conn = DatabaseConnection.getConnection();
                ...
                stmt.setString(1, selectedNote.getNoteID());
                stmt.executeUpdate();
            ...
            notesQueue.remove(selectedNote);

            notesList.setAll(notesQueue);
            recentNotesList.remove(selectedNote);

            Note finalSelectedNote = selectedNote;
            recentNotesStack.removeIf(note -> note.equals(finalSelectedNote));
        ...
        if (selectedNote != null) {
            ...
            if (file != null) {
                try (BufferedWriter writer = new BufferedWriter(new FileWriter(file))) {
                    ...
                    showAlert(Alert.AlertType.INFORMATION,"Success!","Note Downloaded Successfully!");
                } catch (IOException e) {
                    e.printStackTrace();
                }
            }
    ...
    public void uploadFile(File file) {
        if (file != null) {
            try (BufferedReader reader = new BufferedReader(new FileReader(file))) {
                ...
                saveNoteToDatabase(note);
                showAlert(Alert.AlertType.INFORMATION,"Success!","Note Uploaded Successfully!");
