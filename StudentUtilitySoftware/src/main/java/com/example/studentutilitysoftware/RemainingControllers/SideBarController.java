...
import com.example.studentutilitysoftware.ExpenseFeature.ExpenseController;
import com.example.studentutilitysoftware.GraphSim.GraphSimulatorController;
import com.example.studentutilitysoftware.Home;
...
public class SideBarController {
    ...
    @FXML
    protected void GotoGraphSimulator() {
        if (canSwitchFrames()) {
            loadView("/com/example/studentutilitysoftware/GraphSimulator.fxml", 800, "GraphSimulator");
        }
    }
    ...
    private void loadView(String fxmlPath, int viewWidth, String viewName) {
        try {
            ...
            } else if(viewName.equals("GraphSimulator")){
                stage.setMinHeight(737);
                SideBarPane.setPrefHeight(737);
            }
    ...
    private void loadProfileImage(String username) {
        try {
            ...
            e.printStackTrace();
            showAlert("Failed to load profile picture: " + e.getMessage());
        }
    }
